            ...
            public void onClick(View view) {
                ...
                switch (numTask) {
                    case 1:
                        ...
                        mDatabase.child("Tasks").child("1").child("name").setValue(name.getText().toString());
                    ...
                    case 2:
                        ...
                        mDatabase.child("Tasks").child("2").child("name").setValue(name.getText().toString());
                    ...
                    case 3:
                        ...
                        mDatabase.child("Tasks").child("3").child("name").setValue(name.getText().toString());
                    ...
                    case 4:
                        ...
                        mDatabase.child("Tasks").child("4").child("name").setValue(name.getText().toString());
                    ...
                    case 5:
                        ...
                        mDatabase.child("Tasks").child("5").child("name").setValue(name.getText().toString());
                    ...
                    case 6:
                        ...
                        mDatabase.child("Tasks").child("6").child("name").setValue(name.getText().toString());
                    ...
                    case 7:
                        ...
                        mDatabase.child("Tasks").child("7").child("name").setValue(name.getText().toString());
                    ...
                    case 8:
                        ...
                        mDatabase.child("Tasks").child("8").child("name").setValue(name.getText().toString());
                    ...
                    case 9:
                        ...
                        mDatabase.child("Tasks").child("9").child("name").setValue(name.getText().toString());
                    ...
                    case 10:
                        ...
                        mDatabase.child("Tasks").child("10").child("name").setValue(name.getText().toString());
                    ...
                    case 11:
                        ...
                        mDatabase.child("Tasks").child("11").child("name").setValue(name.getText().toString());
                    ...
                    case 12:
                        ...
                        mDatabase.child("Tasks").child("12").child("name").setValue(name.getText().toString());
                    ...
                    case 13:
                        ...
                        mDatabase.child("Tasks").child("13").child("name").setValue(name.getText().toString());
                    ...
                    case 14:
                        ...
                        mDatabase.child("Tasks").child("14").child("name").setValue(name.getText().toString());
                    ...
                    case 15:
                        ...
                        mDatabase.child("Tasks").child("15").child("name").setValue(name.getText().toString());
                    ...
                    case 16:
                        ...
                        mDatabase.child("Tasks").child("16").child("name").setValue(name.getText().toString());
                    ...
                    case 17:
                        ...
                        mDatabase.child("Tasks").child("17").child("name").setValue(name.getText().toString());
                    ...
                    case 18:
                        ...
                        mDatabase.child("Tasks").child("18").child("name").setValue(name.getText().toString());
                    ...
                    case 19:
                        ...
                        mDatabase.child("Tasks").child("19").child("name").setValue(name.getText().toString());
                    ...
                    case 20:
                        ...
                        mDatabase.child("Tasks").child("20").child("name").setValue(name.getText().toString());
                    ...
                    case 21:
                        ...
                        mDatabase.child("Tasks").child("21").child("name").setValue(name.getText().toString());
                    ...
                    case 22:
                        ...
                        mDatabase.child("Tasks").child("22").child("name").setValue(name.getText().toString());
                    ...
                    case 23:
                        ...
                        mDatabase.child("Tasks").child("23").child("name").setValue(name.getText().toString());
                    ...
                    case 24:
                        ...
                        mDatabase.child("Tasks").child("24").child("name").setValue(name.getText().toString());
                    ...
                    case 25:
                        ...
                        mDatabase.child("Tasks").child("25").child("name").setValue(name.getText().toString());
                    ...
                    case 26:
                        ...
                        mDatabase.child("Tasks").child("26").child("name").setValue(name.getText().toString());
                    ...
                    case 27:
                        ...
                        mDatabase.child("Tasks").child("27").child("name").setValue(name.getText().toString());
                    ...
                    case 28:
                        ...
                        mDatabase.child("Tasks").child("28").child("name").setValue(name.getText().toString());
                    ...
                    case 29:
                        ...
                        mDatabase.child("Tasks").child("29").child("name").setValue(name.getText().toString());
                    ...
                    case 30:
                        ...
                        mDatabase.child("Tasks").child("30").child("name").setValue(name.getText().toString());
